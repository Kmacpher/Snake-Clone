 ...
 * Bee Mushrooms are worth 5 points and show up 80% of the time. When a snake comes in contact with the Food,
 ...
 *
 */
public class RedMushroomEntity implements SnakeEntity {

	/**
	 * Constructor takes the location of the BeeMushroomEntity
	 * @param loc
	 */
	public RedMushroomEntity(Location<SnakeBlock,SnakeEntity> loc) {
        location = loc;
